namespace VolskSoft.Bibliotheca.Configuration
{
    ...
    /// <summary>
    /// Class contains settings values.
    /// Key is CAPITALIZED during Add() operation.
    /// </summary>
    [SuppressMessage("Microsoft.Design", "CA1010:CollectionsShouldImplementGenericInterface", Justification = "Will be refactored later.")]
    [Serializable]
